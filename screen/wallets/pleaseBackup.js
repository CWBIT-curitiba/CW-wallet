...
export default class PleaseBackup extends Component {
  ...
  render() {
    ...
    return (
      ...
      <BlueText style={{ textAlign: 'center', padding: 20, fontWeight: 'bold', color: '#0C2550' }}>{loc.pleasebackup.success}</BlueText>
        ...
        <View style={{ 
          ...
          padding: 16,
            ...
            <View style={{ width: 'auto', marginRight: 8, marginBottom: 8 }}>
              <Badge containerStyle={{ backgroundColor: '#f5f5f5', paddingTop: 6, paddingBottom: 6, paddingLeft: 8, paddingRight: 8, borderRadius: 4 }}>
        ...
        <View style={{ flex: 1, justifyContent: 'center',  alignItems: 'center', flexWrap: 'wrap', paddingTop: 24 }}>
            <View style={{ flex: 1 }}>
            <BlueSpacing20 />
